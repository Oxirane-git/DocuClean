...
source_dir = "clean"
destination_dir = "clean_dataset"

# Create destination directory if it doesn't exist
os.makedirs(destination_dir, exist_ok=True)

# Get all PNG files from the clean directory
clean_files = [f for f in os.listdir(source_dir) if f.lower().endswith('.png')]

print(f"Found {len(clean_files)} images in {source_dir}")
...
for filename in clean_files:
    ...
    # Example: "Fontfre_Clean_TE.png" -> "TE"
...
print("-" * 60)
print(f"\nTotal images organized: {len(clean_files)}")
